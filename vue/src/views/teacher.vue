<template>
  <div v-if="this.user.role == 1" style="padding: 10px">
    ...
    <div style="margin: 10px 0">
      ...
      <el-input v-model="username" clearable placeholder="请输入账号" style="width: 20%;margin-left: 20px"
                @change="load"></el-input>
    ...
    <el-table :cell-style="{'text-align':'center'}" :data="tableData" :header-cell-style="{'text-align':'center'}"
      ...
      <el-table-column label="QQ" prop="qq" width="auto"/>
...
export default {
  ...
  methods: {
    ...
    exp() {
      ...
      window.open("/api/user/export?name=" + this.search + "&username=" + this.username + "&role=" + this.role)
    },
